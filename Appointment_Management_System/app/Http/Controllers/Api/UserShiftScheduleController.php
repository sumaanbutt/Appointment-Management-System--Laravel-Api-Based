        ...
        try{
            ...
            foreach($schedules as $schedule){
                ...
                if($request->start_time && $request->end_time){
                    ...
                    if($request->start_time < $schedule->shift_start_time || $request->end_time > $schedule->shift_end_time)
                    {
                        $isAvailable = false;
                    }
                }
                ...
                if($isAvailable)
                {
                    $available[] = [
                        ...
                        'location'=> $schedule->location_code,
                        'user_type'=> $schedule->employee_type
                    ];
                } else{
                    $unavailable[] = [
                        'user_code'=> $schedule->user_code,
                        'reason'=> 'Outside shift timing'
                    ];
                }
            }
