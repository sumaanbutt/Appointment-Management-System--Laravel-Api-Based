...
class CreateScheduleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            '*.working_days'     => ['sometimes', 'string', 'in:MONDAY,TUESDAY,WEDNESDAY,THURSDAY,FRIDAY,SATURDAY,SUNDAY'],
            '*.location_code'    => ['sometimes', 'string', 'exists:business_locations,code'],
